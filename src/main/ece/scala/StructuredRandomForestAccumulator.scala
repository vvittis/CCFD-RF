...
//asdasd
  ...
  /*This is a change */
    ...
    // Group by with watermark (tumbling or sliding window)
    ...
    */
    ...
    val kafkaResult = flatMapResult
      .map(flatMapResult => flatMapResult.keyTuple.toString.concat(",")
